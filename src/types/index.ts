...
export interface Activity {
  ...
  source?: ActivitySource; // the uploaded PDF an activity is built around
  questions: Question[];
...
// An uploaded activity is just source material (a PDF); everything else is the
// team's collaborative workspace around it.
...
export type ResourceKind = "proposal" | "report" | "contract" | "whiteboard";
...
export interface AudioDiscussion {
  id: string;
  teamId: string;
  activityId: string;
  title: string;
...
// Auto-generated by AI from the team's resources + discussions (✦). Faculty-reviewable.
